import { Surah, Para, Page, Hizb } from './types';

export const SURAHS: Surah[] = [
  { id: 1, name: 'Al-Fatihah', arabicName: 'الفاتحة', type: 'MECCAN', versesCount: 7, ayats: [
  ...
  { id: 2, name: 'Al-Baqarah', arabicName: 'البقرة', type: 'MEDINIAN', versesCount: 286, ayats: [
...
const PARA_NAMES = [
  "Alif Lam Meem", "Sayaqool", "Tilkal Rusull", "Lan Tanaloo", "Wal Mohsanat",
  "La Yuhibbullah", "Wa Iza Samiu", "Walau Annana", "Qalal Malao", "Wa'lamu",
  "Ya'taziroon", "Wa Ma Min Da'abbatin", "Wa Ma Ubabri'u", "Rubama", "Subhanallazi",
  "Qal Alam", "Iqtaraba", "Qad Aflaha", "Wa Qalallazina", "Aman Khalaqa",
  "Utlu Ma Oohiya", "Wa Manyaqnut", "Wa Mali", "Faman Azlam", "Elahe Yuruddo",
